...
resource "aws_instance" "webserver" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo certbot --nginx -d app.givemyresume.tech -n -m balasubhayu99@gmail.com --eff-email --agree-tos",
      "sudo certbot --nginx -d api.givemyresume.tech -n -m balasubhayu99@gmail.com --eff-email --agree-tos",
