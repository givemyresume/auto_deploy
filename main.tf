...
resource "aws_instance" "webserver" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo /usr/local/bin/docker-compose -f /home/ubuntu/auto_deploy/docker-compose.yml -p resumebuilder up | tee /home/ubuntu/auto_deploy/run.log" #skipping this command as it's not getting executed
    ]
  }
}
